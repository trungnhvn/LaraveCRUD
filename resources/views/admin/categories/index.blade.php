                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Cate Name</th><th>Cate Desc</th><th>Cate Img</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($categories as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->cate_name }}</td><td>{{ $item->cate_desc }}</td><td><img src="{{asset('/Uploads/'.$item->cate_img)}}" width="100px"/></td>
                                        <td>
